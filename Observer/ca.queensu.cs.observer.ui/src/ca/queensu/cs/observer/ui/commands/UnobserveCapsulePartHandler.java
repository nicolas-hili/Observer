 ...
 *
 * Description: this code is an handler to un-observe a capsule part.
 *
 * Contributors:
...
public class UnobserveCapsulePartHandler extends ObserveHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			...
			unapplyObservableCapsulePartStereotype(capsulePart, editingDomain);
	...
	private void unapplyObservableCapsulePartStereotype(Property capsulePart, TransactionalEditingDomain editingDomain) {
		Stereotype stereotype = capsulePart.getAppliedStereotype("Observation::ObservableCapsulePart");
		unapplyObservableStereotype(capsulePart, stereotype, editingDomain);
	}
